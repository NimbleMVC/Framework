...
/**
 * Required when another field is missing/empty.
 */
class RequiredWithout extends AbstractRule implements ContextAwareRuleInterface
{
    ...
    public function validateInContext(mixed $value, string $field, array $data): void
    {
        ...
        if ($this->isEmpty($value)) {
            $this->fail(str_replace(':field', $this->otherField, $this->msg('requiredWithout')));
        }
    }
